    ...
    <div class="container mx-auto px-4">
        <div class="game-details flex flex-col lg:flex-row border-b border-gray-800">
            <div class="flex-none pb-12">
                <img src="{{ Str::replaceFirst('thumb', 'cover_big', $game['cover']['url']) }}" alt="fotec">
            </div>
            <div class="ml-12">
                    ...
                    <div class="flex space-x-4">
                        @if (isset($game['social']['instagram']))
                            <div class="bg-gray-800 rounded-full w-8 h-8 flex items-center justify-center">
                                    <a href="{{$game['social']['instagram']['url']}}" class="hover:outline-none">
                        ...
                        @if (isset($game['social']['twitter']))
                            <div class="bg-gray-800 rounded-full w-8 h-8 flex items-center justify-center">
                                <a href="{{$game['social']['twitter']['url']}}" class="hover:outline-none">
                        ...
                        @if (isset($game['social']['facebook']))
                            <div class="bg-gray-800 rounded-full w-8 h-8 flex items-center justify-center">
                                <a href="{{$game['social']['facebook']['url']}}" class="hover:outline-none">
